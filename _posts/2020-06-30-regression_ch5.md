...
### quadratic form
Let $$x = (x_1 x_2 \cdots x_n)$$ be a vector with $$n$$ entries/variables, and $$A$$ be a $$n$$ by $$n$$ square matrix. **$$x^tAx$$** is called a quadratic form of $$x$$ with respect to $$A$$ because it represents *any quadratic function* of variable $$x$$.
$$$$x^tAx = a_{11}x_1^2 + (a_{12} + a_{21})x_1x_2 + (a_{13} + a_{31})x_1x_3 + \cdots + a_{nn}x_n^2$$$$
...
> $$\because \sigma^2(e) = \sigma^2[(I-H)Y] = (I-H)\sigma^2(Y)(I-H)^t$$
> $$= (I-H)\sigma^2I(I-H) = \sigma^2(I-H)^2I = \sigma^2(I-H)$$
